    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <nav className="bg-black border-b border-gray-800 sticky top-0 z-50">
        <div className="flex items-center justify-between px-8 h-[70px]">
          ...
          <button className="bg-blue-900 hover:bg-blue-800 border border-blue-500 text-white px-6 py-3 rounded text-sm font-semibold font-inter transition">
            Get Started
          </button>
        </div>
      </nav>
      ...
      <section id="home" className="bg-black py-24 px-8">
        <div className="max-w-4xl mx-auto flex flex-col items-center justify-center gap-8">
          ...
          <button className="bg-blue-900 hover:bg-blue-800 border border-blue-500 text-white px-8 py-3 rounded text-base font-semibold font-inter transition">
            Get Started
          </button>
        </div>
      </section>
          ...
          <div className="grid grid-cols-5 gap-5 max-w-full justify-between">
            {[1, 2, 3, 4, 5].map((feature) => (
              ...
              >
                ...
                <div className="text-gray-500 text-sm">Feature {feature}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 gap-4 max-w-full">
            {[1, 2, 3].map((testimonial) => (
              ...
              >
                ...
                <div className="text-gray-500 text-sm">Testimonial {testimonial}</div>
              </div>
            ))}
          </div>
        </div>
